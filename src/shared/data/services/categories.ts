...
export const categories = {
	...
	"slesarnyj-remont": {
		...
		description:
			"Слесарный ремонт любой сложности: ремонт тормозной системы, замена сцепления, подшипников, сайлентблоков. Рыба текст на 2 строки. Следует отметить, что высокое качество позиционных исследований требует определения и уточнения распределения внутренних резервов и ресурсов. Наше дело не так...",
		items: [
			"zamena-scepleniya",
